...
def register():
    ...
    bpy.types.VIEWLAYER_PT_layer.append(ui.draw_operators)
    bpy.types.NODE_MT_editor_menus.append(ui.draw_menu)
...
def unregister():
    ...
    bpy.types.VIEWLAYER_PT_layer.remove(ui.draw_operators)
    bpy.types.NODE_MT_editor_menus.remove(ui.draw_menu)